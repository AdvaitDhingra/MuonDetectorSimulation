...
void cosmicRays()
{
	...
	for (int j = 0; j < 1e5; j++)
	{
		...
		if (r_2d <= detectorRadius)
		{
			...
			else
			{
				...
				if (escapePointRadiusZ <= detectorRadius && entryRadius <= detectorRadius)
				{ //particle entered and exited from the top and bottom
				...
				else if (escapePointRadiusZ <= detectorRadius && escapePointRadiusZ <= detectorRadius)
				{ // particle entered from the side and exited from the bottom
					sideView->Fill(entryPoint->X(), entryPoint->Z());
	...
	c1->Print("assets/Projection.png");
	c2->Print("assets/Phi.png");
	c3->Print("assets/Theta.png");
	c4->Print("assets/Angular.png");
	c5->Print("assets/topExit.png");
	c6->Print("assets/topEntry.png");
	c7->Print("assets/sideView.png");
	c8->Print("assets/distanceTravelled.png");
	c9->Print("assets/E.png");
}
